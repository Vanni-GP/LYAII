...
public class MainController {
    ...
    private VBox crearEncabezado() {
        ...
        Label subtitulo = new Label("U1: Análisis Semántico  |  U2: Código Intermedio  |  U3: Optimización y Costos");
    ...
    private ToolBar crearBarraHerramientas() {
        Button btnAnalizar = new Button("▶ Compilar y Optimizar");
        ...
        Button btnEjemploOptim = new Button("Ejemplo U3 (Optimización)");
        btnEjemploOptim.setStyle("-fx-background-color: #a6e3a1; -fx-text-fill: #11111b; -fx-font-weight: bold; -fx-cursor: hand;");
        btnEjemploOptim.setOnAction(e -> cargarEjemploOptimizacion());

        Button btnEjemploU2 = new Button("Ejemplo U2");
        btnEjemploU2.setStyle("-fx-background-color: #313244; -fx-text-fill: #cdd6f4; -fx-cursor: hand;");
        btnEjemploU2.setOnAction(e -> cargarEjemploCorrecto());

        Button btnEjemploError = new Button("Ejemplo Error");
        btnEjemploError.setStyle("-fx-background-color: #313244; -fx-text-fill: #cdd6f4; -fx-cursor: hand;");
        btnEjemploError.setOnAction(e -> cargarEjemploError());
    ...
    private VBox crearPanelIzquierdo() {
        ...
        codigoArea.setPromptText("// Código fuente...");
    ...
    private VBox crearPanelDerecho() {
        ...
        tabPrincipal.getTabs().addAll(tabU1, tabU2, tabU3, tabDatos);
    ...
    // =========================================================
    // CONSTRUCCIÓN DE LA PESTAÑA UNIDAD 3
    // =========================================================
    ...
    // =========================================================
    // EJECUCIÓN DEL COMPILADOR COMPLETO (U1, U2 y U3)
    // =========================================================
    ...
    private void analizar() {
        ...
        if (analizador.hayErrores()) {
            ...
            return; // No generar intermedio ni optimizar si hay errores semánticos
        } else {
            consolaRapidaArea.setStyle("-fx-font-family: 'Consolas'; -fx-control-inner-background: #11111b; -fx-text-fill: #a6e3a1;");
            consolaRapidaArea.setText("✓ Compilación y optimización completadas exitosamente.");
    ...
    // =========================================================
    // PROCESAMIENTO Y VISUALIZACIÓN U3
    // =========================================================
    ...
    private void ejecutarOptimizaciones() {
        ...
        sbCostos.append("\nCRITERIOS PARA MEJORAR EL CÓDIGO (3.2.2):\n");
        sbCostos.append("• Se preserva el comportamiento semántico garantizando equivalencia de estado.\n");
        sbCostos.append("• Se reduce la presión en la pila y registros al eliminar variables temporales muertas.\n");
        sbCostos.append("• Se minimiza el tráfico de memoria reduciendo accesos redundantes.\n");
